                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              if ((getEventStateForDay(_selectedDay!) as dynamic) != null &&
                                  (( getEventStateForDay(_selectedDay!) as dynamic).state == 'open' || (getEventStateForDay(_selectedDay!) as dynamic).state == null))
                                OutlinedButton.icon(
                                  icon: Icon(
                                    Icons.qr_code,
                                    color:
